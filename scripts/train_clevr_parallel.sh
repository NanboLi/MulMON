...
data_path=../data/MultiObj/clevr
repo_path=.
log_path=${repo_path}/logs

python train_parallel.py --arch aug_MulMON --datatype clevr_aug --work_mode training \
--input_dir ${data_path} --output_dir ${log_path} --resume_epoch 4000 \
