...
* **Get Datasets**  
  * **Easy way**:  
    Download our datasets:  
      ...
      * [gqn-jaco.tar.gz](https://drive.google.com/file/d/1xDm0InpO6jLILbOFN5MhaoJvjenDzuaD/view?usp=sharing) and place it under the `<YOUR-PATH>/mulmon_datasets/GQN/` directory (~3.2GB when extracted).  
